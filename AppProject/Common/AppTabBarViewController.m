...
//        if (!APPCONTEXT.currentUser.isLogin) {
////            ZSCLoginViewController *vc = [[ZSCLoginViewController alloc]init];
////            [AppNavigator showModalNavigationController:vc animated:YES];
//            return NO;
//        } else {
//            return YES;
//        }
