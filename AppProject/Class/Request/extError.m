...
+ (extError*)errorWithRestInfo:(NSDictionary*)restInfo {
	...
	extError* error = [extError errorWithDomain:@"Joybike" code:[errorCode intValue] userInfo:restInfo];
	return error;
}	
...
+ (extError*)errorWithCode:(NSInteger)code errorMessage:(NSString*)errorMessage {
	...
	extError* error = [extError errorWithDomain:@"Joybike" code:code userInfo:userInfo];
	return error;
