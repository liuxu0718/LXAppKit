...
+ (NSString *) machineModelName{
    ...
    if ([machineModel isEqualToString:@"iPhone5,1"])    return @"iPhone 5";
    if ([machineModel isEqualToString:@"iPhone5,2"])    return @"iPhone 5S";
    if ([machineModel isEqualToString:@"iPhone6,1"])    return @"iPhone 6";
    if ([machineModel isEqualToString:@"iPhone6,2"])    return @"iPhone 6P";
    if ([machineModel isEqualToString:@"iPhone8,1"])    return @"iPhone 6S";
    if ([machineModel isEqualToString:@"iPhone8,2"])    return @"iPhone 6SP";
    //无型号匹配
