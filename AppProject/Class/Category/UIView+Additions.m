...
- (void)markBorderWithRandomColor{
    ...
    self.layer.borderColor = [UIColor colorWithRed:arc4random() % 255 green:arc4random() % 255 blue:arc4random() % 255 alpha:1].CGColor;
...
//    NSLog(@"syp====setTHChidden==%d,class==%@",ishidden,[self className]);
//}
